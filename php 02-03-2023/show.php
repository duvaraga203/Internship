    ...
    <div class="container bg-dark">
        ...
        <div class="container row">
            ...
            <form class="col-lg-4 offset-lg-4 mt-2 mb-2 p-2 bg-info" method="post" action="show.php">
                <label for="Rno" class="ml-4 mt-5 mr-3">Rollno</label>
                <input class="ml-4" type="number" name="Rno" placeholder="Enter your rollno"> <br>
                <div class="row">
                    <input class="mt-3 bg-success col-6 offset-3" type="submit" name="submit1" value="Show details">
                </div>
                <span><a href="./main.php" class="ml-5 text-light">Save details</a><a href="./update.php"
