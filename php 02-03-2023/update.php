    ...
    <div class="container bg-dark">
        ...
        <div class="container row">
            <form class="col-lg-4 offset-lg-4 mt-2 mb-2 p-2 bg-info" method="post" action="update.php">
                ...
                <input class="ml-5" type="number" name="uno" placeholder="Enter your rollno" required> <br>
                <label for="uname" class="ml-3 mt-3 mr-2">Update name</label>
                <input class="mr-1 ml-4" type="text" name="uname" placeholder="Enter your name" required> <br>
                <label for="uage" class="ml-3 mt-3">Update age</label>
                <input class="ml-5" type="text" name="uage" placeholder="Enter your age" required> <br>
                <label for="pass" class="ml-3 mt-3">Update password</label>
                <input class="ml-2" type="password" name="upass" placeholder="Enter your password" required> <br>
                <div class="row">
