  ...
  <div class="container bg-dark text-light">
    ...
    <form action="validate.php" method="post" class="col-7 offset-lg-4 p-3">
      <div class="form-group row mt-2">
        ...
        <input class="col-lg-4 col-sm-12" type="text" id="id1" placeholder="Enter your User Name" name="username"
          required />
      </div>
      <div class="form-group row mt-4">
        <label class="col-lg-2" for="id2">Password</label>
        <input class="col-lg-4 col-sm-12" type="password" id="id2" placeholder="Enter your password" name="password"
          required />
      </div>
